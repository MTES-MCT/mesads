...
EXCLUDE_MODULES = [
    r".*autocomplete.*",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_add$",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_change$",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_changelist$",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_compare$",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_delete$",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_history$",
    r"^(app.*|auth_.*|users_.*|fradm_.*|vehicules_relais_.*|newsletters_.*)_list$",
